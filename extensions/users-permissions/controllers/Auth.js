...
module.exports = {
  ...
  async register(ctx) {
    ...
    try {
      ...
      // strapi.log.debug('register', params);

      const user = await strapi.query('user', 'users-permissions').create(params);
      const iCountUser = strapi.services.icount.createNewClient(params.email, params.firstname + ' ' + params.lastname);
      
      // strapi.log.debug('iCountUser', iCountUser);
